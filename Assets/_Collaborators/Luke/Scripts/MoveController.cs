...
public class MoveController : NetworkBehaviour
{
  ...
  [SerializeField] private GameObjectVariable clientCameraObject;
  private Transform cameraTransform => clientCameraObject?.Value?.transform;
  ...
  void Start()
  {
    ...
    if (isLocalPlayer)
    {
      ...
      clientCameraObject.Value = cameraObject;
    }
  }

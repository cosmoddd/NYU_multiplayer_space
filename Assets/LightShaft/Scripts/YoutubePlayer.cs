...
public class YoutubePlayer : MonoBehaviour
{
  ...
  IEnumerator YoutubeURLDownloadFinished(Action callback, YoutubePlayer player)
  {
    ...
    if (downloadYoutubeUrlResponse.isValid)
    {
      ...
      try
      {
        ...
        string htmlPlayerVersion = TryMatchHtmlVersion(js, magicResult.regexForHtmlPlayerVersion);
